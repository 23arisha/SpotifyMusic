...
def recommend(musics):
    ...
    for i in music_list:
        ...
        poster_image_url = track['album']['images'][1]['url']
...
if st.button("Recommend"):
    ...
    with col1:
        st.markdown(
            f'<a href="{spotifyurl[0]}" target="_blank"><img src="{posters[0]}" alt="{name[0]}" style="width:100%"></a>',
    ...
    with col2:
        st.markdown(
            f'<a href="{spotifyurl[1]}" target="_blank"><img src="{posters[1]}" alt="{name[1]}" style="width:100%"></a>',
            unsafe_allow_html=True
        )
        st.write(name[1])
    ...
    with col3:
        st.markdown(
            f'<a href="{spotifyurl[2]}" target="_blank"><img src="{posters[2]}" alt="{name[2]}" style="width:100%"></a>',
            unsafe_allow_html=True
        )
        st.write(name[2])
    ...
    with col4:
        st.markdown(
            f'<a href="{spotifyurl[3]}" target="_blank"><img src="{posters[3]}" alt="{name[3]}" style="width:100%"></a>',
            unsafe_allow_html=True
        )
        st.write(name[3])
    ...
    with col5:
        st.markdown(
            f'<a href="{spotifyurl[4]}" target="_blank"><img src="{posters[4]}" alt="{name[4]}" style="width:100%"></a>',
            unsafe_allow_html=True
        )
        st.write(name[4])